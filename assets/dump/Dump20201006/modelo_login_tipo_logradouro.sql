...
CREATE TABLE `tipo_logradouro` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabela com o texto de tratamento do usuário "Sr(a), Sr"\\n';
...
-- Dump completed on 2020-10-06 15:32:11
