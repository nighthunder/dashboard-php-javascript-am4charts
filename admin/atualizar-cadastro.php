                                ...
                                <div class="card-body"><h5 class="card-title">Meus dados pessoais</h5>
                                    <form class="" method="POST" action="../app/controllers/updateusercontroller.php" >
                                        ...
                                        <div class="position-relative form-check">
                                            <input name="atualizacao" id="atualizacao" type="checkbox" class="form-check-input" onclick=" if(document.getElementById('atualizacao').checked != true){ this.value = 'N';} else {this.value = 'S';}" value="<?php echo $userdata[0][""] ?>" <?php echo ($userdata[0]['atualizacao']=='S' ? 'checked' : '');?>><label for="exampleCheck" class="form-check-label" style="font-weight: normal;font-size: 13px;">Aceito receber aviso de atualizações de indicadores.</label><br/>
