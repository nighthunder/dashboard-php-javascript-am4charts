...
function salvarCookie(chave, valor, duracaoEmDias)
  ...
  function enviarFormulario()
  {
   ...
   jQuery(document).ready(function($) {
      ...
      function feedTheFilters(){ // alimenta os filtros a cada refresh
      ...
      $("#opt_regiao").on("change",function(){
          ...
          var area = String($("#opt_area").val()).split("__");
          console.log( "opt_area: " + area[0] ); 
          ...
          setTimeout(function(){ 
            ...
            $('#opt_indicador').html(optindicador_original.html());
            //$('#opt_area').val(String($("#opt_area").val())).prop('selected', true);
      ...
      $("#opt_area").on("change",function(){
          ...
          selectedVal = this.value;
          console.log("opt_area2: " + selectedVal);
          console.log("opt_regiao2: " + String($('#opt_regiao').val().toLowerCase()));
