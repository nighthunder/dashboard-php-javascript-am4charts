                                                        ...
                                                        <?php    
                                                            foreach ($filtro_indicadores as $ind){
                                                                ...
                                                                if (!in_array($ind["INDICADOR"]."__".$ind["id"], $indicadores)){
                                                                    echo "<option data-region='".utf8_encode($ind["REGIAO"])."' value='".utf8_encode($ind["INDICADOR"])."__".utf8_encode($ind["id"])."'>".utf8_encode($ind["GRUPO"])."</option>";
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-12">
                                <div class="mb-3 card">
                                    ...
                                    <div class="card-body col-sm-12 col-lg-12 row">
