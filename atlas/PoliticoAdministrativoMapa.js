...
function mapaPoliticoAdministrativo(regiao, indicador, ano, datum, titulo, dict) {
    console.log("dict depois", dict);
    ...
    if(ano){
        ...
        datum.forEach(element => {
            ...
            // console.log("element", element, arrayAML.includes(element.MICROREGIAO));
    ...
    // console.log("unidade", unidade[0].Unidade);
