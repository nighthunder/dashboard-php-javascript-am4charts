         ...
         <div class="app-main">
                                    ...
                                    <div class="card-body">  
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    <select class="estado" name="select">
            <option value="amazoniaLegal" selected>Amazônia Legal</option> 
          ...
          <!-- ==================================================================================================== -->    
                                ...
                                <div class="card-hover-shadow-2x mb-3 card">
                                    <div class="card-header-tab card-header">
                                        <div class="card-header-title font-size-lg font-weight-normal">Destaques positivos na região <?php echo $_GET["regiao"]; ?></div>
                                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                 ...
                                 <div class="card-hover-shadow-2x mb-3 card">
                                    ...
                                    <div class="card-header-tab card-header">
                                        <div class="card-header-title font-size-lg font-weight-normal">Visão de longo prazo</div>
                                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
                                      ...
                                      <div class="card-body">
                                            ...
                                            <?php        
                                                ...
                                                foreach($graficos_cenarios as $grafico){
                                                    ...
                                                    //var_dump($grafico);
                                                    echo "<iframe width=\"100%\" height=\"450\" src=\"".$place."/assets/plots/".$grafico["arquivo"]."\" frameborder=\"0\" allowfullscreen></iframe>";
                                                    echo "<p>".$grafico["fonte"]."</p>";
                                                    echo "</div>";
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <div class="card-body">
                                        <?php    
                                            echo $perfil->getTextoIndicadorTerritorializacao($_GET["indicador"]);
