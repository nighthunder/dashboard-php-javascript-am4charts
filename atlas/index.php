                    ...
                    <div class="row" style="float: left">
                        <div class="col-lg-12">
                            ...
                            <div class="selects-header">
                                <img class="filtro-ico regiao-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-recorte-geografico.svg">
                                ...
                                <img class="filtro-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-area.svg">
                                ...
                                <img class="filtro-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-indicador.svg">
                                <select class="indicador form-control" name="select">
                                    <option value="" disabled selected>Indicadores</option>
                                </select>
                                <img class="filtro-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-ano.svg">
                                <select class="ano form-control" name="select">
                                    <option value="" disabled selected>Ano</option>
                                </select>
                                <img class="filtro-ico territorio-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-quatro-amazonias.svg">
                                ...
                                <img class="filtro-ico ajust-ico" src="http://crodemu.kinghost.net/assets/images/svg/filtro-proporcao.svg">
                                <div class="row">
                        ...
                        <div class="mb-3 card">
                            ...
                            <div class="card-body">  
                                <div class="card-header">
                                    ...
                                    <button class="btn btn-secondary bg-bordo" id="btn" type="button" disabled>Pesquisar</button> -->
                                </div>        
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        ...
                                        <!-- <div #popup id="popup" [hidden]="true"></div> -->
