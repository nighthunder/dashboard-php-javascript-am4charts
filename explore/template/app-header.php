<div class="app-header bg-green header-shadow header-text-dark">
        <div class="app-header__logo">
            ...
            <div class=""><img src="../assets/images/AML/logo.png"/ id="logo" width="150px" style="margin-top: -15px;margin-left: 39px;margin-right: 10px;"></div>
        </div>
                                        ...
                                        <div class="scroll-area-xs" style="height: 75px;">
                                            <div class="">
                                                <ul class="nav flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="../admin/atualizar-cadastro.php" class="nav-link nav-link-header">Área de atualização cadastral
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
